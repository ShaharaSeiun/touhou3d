...
export const bossDeathQuiet = new MultiSound('/sfx/se_enep01.wav', 0.05);
...
export const playerBombCharge2 = new MultiSound('/sfx/se_power1.wav', 0.3);
export const playerMasterSpark = new MultiSound('/sfx/se_nep00.wav', 1.0);
